...
const Login: React.FC = () => {
  ...
  return (
    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100vh' }}>
      <div style={{ width: '100%', maxWidth: '400px', padding: '20px', border: '1px solid #f0f0f0', borderRadius: '8px', textAlign: 'center' }}>
        <img src="/logo.svg" alt="Logo" style={{ width: '160px', marginBottom: '20px' }} />
        ...
        <Form layout="vertical" onFinish={handleSubmit}>
          ...
          <Form.Item label="Senha" name="password" rules={[{ required: true, message: 'Por favor, insira sua senha!' }]}>
            <Input.Password value={password} onChange={(e) => setPassword(e.target.value)} placeholder="Digite sua senha" />
          </Form.Item>
